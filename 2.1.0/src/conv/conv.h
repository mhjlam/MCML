...
enum beam_type { original, flat, gaussian, arbitrary };

/****
 *  Parameters to describe a photon beam.
 *  Original:  Infinitely narrow beam; default from the MCML output.
 ...
 ****/
typedef struct {
	bool datain;         /* mco data is availalbe. */
...
/**************************************************************************
 *  Dynamic memory allocation routines now use modern MCML implementations.
 *  Function declarations moved to convmcml.h for consistency.
 ****/
