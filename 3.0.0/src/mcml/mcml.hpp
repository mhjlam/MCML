...
/**
 * @brief 3D vector structure for position and direction
 */
struct Vector3 {
...
/*******************************************************************************
 * @brief Photon packet structure containing all photon state information
 ****/
struct Photon {
...
/*******************************************************************************
 * @brief Structure used to describe the geometry and optical properties of a layer.
 *
...
/**
 * @brief Spatial grid configuration for simulation
 */
struct Grid {
