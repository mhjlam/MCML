...
public:
	...
	[[nodiscard]] bool has_value() const noexcept { return std::holds_alternative<std::monostate>(data_); }

	[[nodiscard]] bool has_error() const noexcept { return std::holds_alternative<Error>(data_); }
