...
int main(void) {
	...
	printf("Beam: %s, %g photons\n", mcflag == 0 ? "collimated" : mcflag == 1 ? "Gaussian" : "point source", Nphotons);
	printf("\nRunning simulation...\n");

	/* Run Monte Carlo simulation */
	mcsub(mua, mus, g, n1, n2, NR, NZ, dr, dz, Nphotons, mcflag, xs, ys, zs, boundaryflag, radius, waist, zfocus, J, F,
		  &S, &A, &E, 1); /* PRINTOUT=1 for progress */
	...
	mcsub_save_file(1, J, F, S, A, E, mua, mus, g, n1, n2, mcflag, radius, waist, xs, ys, zs, NR, NZ, dr, dz, Nphotons);
